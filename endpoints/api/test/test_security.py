...
SECURITY_TESTS: List[
    ...
    (OpenAPIResource, "GET", None, None, None, 200),
    (OpenAPIResource, "GET", None, None, "devtable", 200),
    (OpenAPIResource, "GET", None, None, "freshuser", 200),
    (OpenAPIResource, "GET", None, None, "reader", 200),
